resource "kubernetes_validating_webhook_configuration_v1" "validating_webhook_configuration_v1" {
  for_each = { for key, value in var.kubernetes_validating_webhook_configuration_v1 : key => value }
