resource "nexus_repository_maven_proxy" "repository_maven_proxy" {
  for_each = { for key, value in var.nexus_repository_maven_proxy : key => value }
  ...
  http_client {
    ...
    dynamic "authentication" {
      ...
      content {
        ...
        preemptive = authentication.value.preemptive
      }
    }
