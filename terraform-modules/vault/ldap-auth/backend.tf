resource "vault_ldap_auth_backend" "backend" {
  count = var.vault_ldap_auth_backend == null ? 0 : 1

  namespace                  = var.vault_ldap_auth_backend.namespace
  ...
  max_page_size              = var.vault_ldap_auth_backend.max_page_size
  ...
  certificate                = var.vault_ldap_auth_backend.certificate
  ...
  connection_timeout         = var.vault_ldap_auth_backend.connection_timeout
  rotation_period            = var.vault_ldap_auth_backend.rotation_period
  rotation_schedule          = var.vault_ldap_auth_backend.rotation_schedule
  rotation_window            = var.vault_ldap_auth_backend.rotation_window
  disable_automated_rotation = var.vault_ldap_auth_backend.disable_automated_rotation
